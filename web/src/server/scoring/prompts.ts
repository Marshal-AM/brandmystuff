...
3. Derive the object's exposure profile:
   ...
   - prohibited_zones: parts of THIS object where an ad would stop the object working, hide safety or legal information, or break the law. Only functional, safety or legal areas qualify: screens, keyboards and trackpads, lights, windscreens and front side windows, mirrors, number plates, vents and cooling grilles, ports, cameras and sensors, safety or certification labels, fire exits, legally required signage. Manufacturer logos, brand marks, badges, emblems and decorative trim are NEVER prohibited zones: stickers over them are normal and exactly what ad spaces are for (e.g. the Apple logo on a MacBook lid, a car maker's badge, a helmet brand's logo). Empty list if none.
...
"prohibited_zone" is true ONLY when the ad would physically sit on a functional, safety or legal area: screens, keyboards or trackpads, lights, windscreens or front side windows, mirrors, number plates, vents or cooling grilles, ports, cameras or sensors, safety or certification labels, fire exits, or legally required signage. CONTEXT.object.prohibited_zones lists such areas for this object; ignore any entry in it that is a logo, brand mark, badge or emblem. A manufacturer logo, brand mark, badge or emblem inside the section is NEVER a reason: covering it with a sticker is normal and allowed (e.g. a MacBook lid space over the Apple logo is a valid ad space). Being near a prohibited area is not enough; the section itself must be one. When prohibited_zone is false, leave prohibited_reason empty.
