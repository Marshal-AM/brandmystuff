...
export const POST = handler(async (req) => {
  ...
  const heroCheck = { metrics: { phash: r.metrics.phash, eqi: r.metrics.eqi, sharpness: r.metrics.sharpness }, analysis: r.analysis, provenance: r.provenance, nonceOk: r.nonceOk };
